...
function query() {
     ...
     sendAjax("${pageContext.request.contextPath}/queryFoods","GET","foodname="+foodname,function(responseText){
            //返回的是字符串的json
...
function updateFood(){
   ...
   sendAjax("${pageContext.request.contextPath}/updateFood/"+myFoodId,"POST","_method=put&foodName="+myFoodName+"&price="+myFoodPrice,function(responseText){
         if(responseText==1){
